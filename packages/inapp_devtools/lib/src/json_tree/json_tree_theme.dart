...
class JsonTreeTheme extends ThemeExtension<JsonTreeTheme> {
  const JsonTreeTheme({
  ...
  factory JsonTreeTheme.dark() => const JsonTreeTheme(
  ...
  @override
  JsonTreeTheme lerp(ThemeExtension<JsonTreeTheme>? other, double t) {
    if (other is! JsonTreeTheme) return this;
    return JsonTreeTheme(
